export function BasemapSettingsEditor({ registry }) {
  ...
  const savedConfiguration = registry.getProviderConfiguration("maptiler");
  const [draft, setDraft] = React.useState(null);
  const configuration = draft ?? savedConfiguration ?? { apiKey: "" };
  const configured = savedConfiguration != null;
  ...
  async function save() {
    ...
    setStatus(null);
    try {
      await registry.replaceProviderConfiguration("maptiler", configuration);
      setDraft(null);
