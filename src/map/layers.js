...
import { MAP_SOURCE_ID, RUNTIME_LAYER_PREFIX } from "../maplibre/runtime-constants.js";
  ...
  try {
    ...
    return {
      ...
      diagnostic: diagnostic(
        "layer.invalid-json",
        sourceBlockUid,
        "This MapLibre layer child is not valid JSON.",
  ...
  if (!layer || typeof layer !== "object" || Array.isArray(layer)) {
    return {
      ...
      diagnostic: diagnostic(
        ...
        sourceBlockUid,
        "A MapLibre layer block must contain one layer object.",
      ),
    };
  }
