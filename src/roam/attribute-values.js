// Roam returns attribute relations in both HARC maps and legacy tuple-shaped values.
// These small readers hide those storage shapes from the map-domain modules.
